...
#ifndef MARL_UPDATE_SELECT_REQUEST_HPP
#define MARL_UPDATE_SELECT_REQUEST_HPP
...
struct LIBMARL_API update_table_req : public request_base {
...
#endif // MARL_UPDATE_SELECT_REQUEST_HPP
