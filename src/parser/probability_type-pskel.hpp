...
#ifndef LIBMARL_PROBABILITY_TYPE_PSKEL_HPP
#define LIBMARL_PROBABILITY_TYPE_PSKEL_HPP
...
class probability_type_pskel: public virtual ::xml_schema::decimal_pskel
{
  public:
...
#endif // LIBMARL_PROBABILITY_TYPE_PSKEL_HPP
