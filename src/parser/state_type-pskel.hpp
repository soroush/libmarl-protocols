...
#ifndef LIBMARL_STATE_TYPE_PSKEL_HPP
#define LIBMARL_STATE_TYPE_PSKEL_HPP
...
class title_pskel;
class state_type_pskel: public ::xml_schema::complex_content
{
  public:
...
#endif // LIBMARL_STATE_TYPE_PSKEL_HPP
