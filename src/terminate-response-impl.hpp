...
#ifndef MARL_TERMINATE_RESPONSE_IMPL_HPP
#define MARL_TERMINATE_RESPONSE_IMPL_HPP
...
void serialize(Archive& archive, marl::terminate_response& m) {
    archive(cereal::base_class<marl::message_base>(&m));
}
}

CEREAL_REGISTER_TYPE(marl::terminate_response)
CEREAL_REGISTER_POLYMORPHIC_RELATION(marl::message_base, marl::terminate_response)

#endif // MARL_TERMINATE_RESPONSE_IMPL_HPP
